...
- [Complete Bun Native API Reference](#complete-bun-native-api-reference)
  ...
  - [Redis (Valkey) Client](#redis-valkey-client)
  - [FFI](#ffi)
  - [DNS](#dns)
  - [Testing](#testing)
  - [Workers](#workers)
  ...
  - [String \& Text Processing](#string--text-processing)
  - [URL \& Path Utilities](#url--path-utilities)
  ...
  - [📊 Node.js → Bun Migration Map](#-nodejs--bun-migration-map)
